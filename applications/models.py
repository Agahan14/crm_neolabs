...
class Groups(models.Model):
    ...
    name = models.CharField(max_length=100)
    teacher = models.ForeignKey('users.Teacher', on_delete=models.CASCADE, null=True, related_name='teacher')
    ...
    status = models.ForeignKey(GroupStatus, on_delete=models.SET_NULL, null=True, blank=True)

    def save(self, *args, **kwargs):
        self.end_date = self.start_date + datetime.timedelta(days=self.direction.duration * 30)
...
class Application(models.Model):
    ...
    status = models.PositiveSmallIntegerField(choices=APPLICATION_CHOICES, default=1, null=True, blank=True)
