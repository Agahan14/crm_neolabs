...
from rest_framework.viewsets import views, generics
...
class UserArchieveUpdateRetrieveView(views.APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(data={'message': ('User successfully archived!')}, status=status.HTTP_200_OK)
...
class UserUnarchieveUpdateRetrieveView(views.APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(data={'message': ('User successfully unarchived!')}, status=status.HTTP_200_OK)
...
class AddToStudentView(views.APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not application.transaction:
            ...
            student.status = 1
            student.save()
        return Response(data={'message': ('Student successfully added!')}, status=status.HTTP_200_OK)
